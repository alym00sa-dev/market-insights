...
class EnsembleSignalExtractor:
    ...
    def __init__(
        ...
        # Provider Intelligence (integrated)
        self.provider_intelligence = ProviderIntelligence(
    ...
    def extract(
        ...
        try:
            ...
            print(f"\nUpdating provider intelligence for {provider}...")
            provider_profile = self.provider_intelligence.update_profile(
                event=synthesized_event,
                ensemble_metrics=metrics
            )
            print(f"✓ Provider profile updated ({provider_profile.total_events} total events)")
